...
<head>
    ...
    <title>Paid Billings Report</title>
    <style>
...
<body>
    ...
    <div class="header">
        <h1 class="title">Paid Billings Report</h1>
    ...
    <table>
        <thead>
            <tr>
                <th style="width: 15%;">Billing ID</th>
                <th style="width: 24%;">Name of Tutee</th>
                <th style="width: 20%;">Billing Date</th>
                <th class="right" style="width: 10%;">Hours</th>
                <th class="right" style="width: 11%;">Amount</th>
                <th class="right" style="width: 11%;">Total Paid</th>
        ...
        <tbody>
            @forelse($billings as $billing)
                <tr>
                    ...
                    <td class="right">{{ number_format((float) ($billing['total_hours'] ?? 0), 2) }}</td>
            ...
            @empty
                <tr>
                    <td colspan="7" class="muted">No paid billings found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table class="totals">
        <tbody>
            <tr>
                ...
                <td class="right">{{ $formatAmount($totalAmount ?? 0) }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="right">{{ number_format((float) ($totalHours ?? 0), 2) }}</td>
            </tr>
        </tbody>
    </table>
